...
public class CustomerProjection {
    ...
    public void processCustomerUpdatedEvent(CustomerUpdated customerUpdatedEvent) {
        ...
        customerService.updateCustomer(new CustomerQueryModel(customerUpdatedEvent.getCustomerId(), customerUpdatedEvent.getFirstName(), customerUpdatedEvent.getLastName(), customerUpdatedEvent.getAddress(), customerUpdatedEvent.getBirthday()));
    }
}
